...
<html lang="pt">
<head>
<title>Centro Médico Eden</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Centro Médico Eden">
...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="emergencies  d-flex flex-row align-items-center justify-content-start ml-auto">Emergencias: (+244) 942 020 450</div>
						</div>
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="about.html">Sobre Nos</a></li>
					<li class="menu_item menu_mm"><a href="services.html">Serviços</a></li>
					<li class="menu_item menu_mm"><a href="news.html">News</a></li>
					<li class="menu_item menu_mm"><a href="contact.html">Contactos</a></li> -->
					<li class="menu_item menu_mm"><a href="index.php">Home</a></li>
					<li class="menu_item menu_mm"><a href="#">Sobre Nos</a></li>
					<li class="menu_item menu_mm"><a href="">Serviços</a></li>
					<li class="menu_item menu_mm"><a href="#">Casos Clinicos</a></li>
					<li class="menu_item menu_mm"><a href="#">Contactos</a></li>
				</ul>
			</div>
			<div class="menu_extra">
				<div class="menu_appointment"><a href="#">Request an Appointment</a></div>
				<div class="menu_emergencies">Para Emergencias: (+244) 942 020 450</div>
			</div>
	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(images/bg-02.jpg)"></div>
					<div class="home_content">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										<div class="home_title"><h1>A tua saúde é nossoa maior prioridade</h1></div>
										<div class="home_text">
			...
			<div class="row">
				...
				<div class="col-lg-4 box_col">
					<div class="box working_hours">
						...
						<div class="box_title">Horário de Atendimento</div>
						<div class="working_hours_list">
							<ul>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Segunda – Sexta-Feira</div>
									<div class="ml-auto">8h00 – 19h00</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Sábado</div>
									<div class="ml-auto">9h30 – 17h00</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Domingo</div>
									<div class="ml-auto">9h30 – 15h00</div>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-lg-4 box_col">
					<div class="box box_emergency">
						...
						<div class="box_title">Contactos de Emergencias</div>
						<div class="box_phone">(+244) 942 020 450</div>
	...
	<div class="departments">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title section_title_light"><h2>Nossos Departamentos</h2></div>
				</div>
			</div>
			<div class="row departments_row row-md-eq-height">
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						...
						<div class="dept_content text-center">
							<div class="dept_title">Gastroenterologia</div>
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						...
						<div class="dept_content text-center">
							<div class="dept_title">Fisioterapia</div>
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						...
						<div class="button dept_button"><a href="#">Leia Mais</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="services">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title"><h2>Nossos Serviços</h2></div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Pedratria</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Cardiologia</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Ortopedia</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Medicina Dentaria</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Neurologia</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					...
					<a href="#">
						<div class="service text-center trans_200">
							...
							<div class="service_title trans_200">Nutrição</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							...
							<ul class="footer_about_list">
								<li><div class="footer_about_icon"><img src="images/phone-call.svg" alt=""></div><span>(+244) 942 020 450 | 912 755 204</span></li>
								<li><div class="footer_about_icon"><img src="images/envelope.svg" alt=""></div><span>geral@clinicaeden.org</span></li>
								<li><div class="footer_about_icon"><img src="images/placeholder.svg" alt=""></div><span>Rua dos Lírios nº61, Urb. Jardins do Éden, Camama, Município de Belas, Luanda-Angola</span></li>
							</ul>
						</div>
					</div>
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_links footer_column">
							<div class="footer_title">Outras Entidade</div>
							<ul>
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_news footer_column">
							<div class="footer_title">Links de interesse </div>
							<ul>
								<li>
									<div class="footer_news_title"><a href="news.html">Aliquam ac eleifend metus</a></div>
									<div class="footer_news_date">Junho 10, 2020</div>
								</li>
								<li>
			...
			<div class="container">
				<div class="row">
					<div class="col">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os Direitos Reservados <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Centro Medico Eden</a>
